    ...
    def generate_word_data(self) -> None:
        """
            ...
            build a directory structure as below with the png data representing words.
                    ...
                    |--- ...             |-- page_0/ |-- sentences_0_0/ |-- words/ |-- word_0_0_0.png
                    |                    |   ...         ...                            ...
            data/ --|--- tex_filename/--- |-- page_i/ |-- sentences_i_0/ |-- words/ |-- word_i_0_0.png
                    |                    |   ...         ...                            ...
                    |--- ...             |-- page_n/ |-- sentences_n_0/ |-- words/ |-- word_n_0_0.png
        """
        ...
        for i, png in enumerate(page_pngs):
            ...
            for j, sentence in enumerate(sentences):
                ...
                # Find the letters in the sentence
